...
use resol_vbus::*;
use resol_vbus::specification::{DataSetPacketField, DataSetPacketFieldIterator};
...
impl<'a> FilteredFieldIterator<'a> {
    ...
    pub fn new(spec: &'a Specification, filters: Vec<PacketFieldId<'a>>) -> FilteredFieldIterator<'a> {
