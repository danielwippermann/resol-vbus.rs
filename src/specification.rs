...
mod tests {
    ...
    fn test_get_or_create_cached_device_spec() {
        ...
        // Test device template with both self and peer mask
        let bytes = &[
            0x41, 0x9f, 0x41, 0x9f, 0xa4, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x78, 0x00,
            ...
            0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0xff, 0xff, 0x11, 0x7e, 0xff, 0xff, 0x00, 0x00,
        ...
        let spec_file = SpecificationFile::from_bytes(bytes)
            .expect("Should be able to parse specification file");
        ...
        assert_eq!("00_0010_7E11", &device_spec.device_id);
        assert_eq!("", &device_spec.name);
        ...
        assert_eq!("00_0010", &device_spec.device_id);
        assert_eq!("Unknown device 0x0010", &device_spec.name);
    }
